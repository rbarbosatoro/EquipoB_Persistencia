							...
							<div class="modal-body">
								<div class="form-group">
									<label for="">Empresa</label> <input name="Empresa"
										type="text" class="form-control" id="exempresa"
										placeholder="Empresa">
								</div>
								<div class="form-group">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<table
					...
					<tr class="text-center">
						...
						<td style="width: 10%"><button id="editarformacion" type="submit" class="btn btn-warning" data-toggle="modal" data-target="#modal-formacion" >Editar</button></td>
			...
			<c:forEach items= "${formacion}" var="for">
				<tr data-id="${for.id}">
					...
					<td id="centroformacion">${for.especializacion}</td>
